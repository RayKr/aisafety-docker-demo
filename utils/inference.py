...
dataset = os.getenv("ENV_DATASET", default="data/ImageNet1000_100")  # 基础数据集
c_dataset = os.getenv("ENV_CHILDDATASET", default="data/fgsm_ImageNet1000_100")  # 子数据集
save_path = os.getenv("ENV_RESULT", default="result")  # 中间结果存储路径
